...
//     try{
//         // if find is empty it will return everything in the db
...
//     bcrypt.hash(update.password, salt, (hash)=>{
...
// create Comment
router.post('/createComment/:id/:postID', async function(req,res, next) {
    const email = req.user.email;
    var numberComments;
...
// update comment
router.post('/comment/edit/:id/:postID', (req ,res, next) =>{
    const id = req.params.id;
    var postID = req.params.postID
...
router.get('/comment/delete/:id/:author/:postID', async  (req ,res, next) =>{
...
router.get('/hello/aboutus',checkAuthentication,async function(req,res){
    res.render('aboutus',{
...
router.get('/specposts/:id',checkAuthentication, async function(req,res,next){
